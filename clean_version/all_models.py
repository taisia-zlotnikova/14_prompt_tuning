...
def my_model(tokenizer, prompt_length=20, init_prompt='', name_model='t5-small'):
    print(f'prompt len = {prompt_length}, init_prompt = {init_prompt}, name_model = {name_model}')
...
def peft_model(tokenizer, prompt_length=20, init_prompt='', name_model='t5-small'):
    print(f'prompt len = {prompt_length}, init_prompt = {init_prompt}, name_model = {name_model}')
